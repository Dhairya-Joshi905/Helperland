                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        if (!user)
                                            // 404?
                                            return [2 /*return*/, res.status(404).json({ error: "User with this token does not exist." })];
                                        return [4 /*yield*/, bcrypt_1.default.compare(req.body.newPassword, user.Password)];
                                    case 1:
                                        Same = _b.sent();
                                        if (!Same) return [3 /*break*/, 2];
                                        return [2 /*return*/, res.status(200).json({ message: "This is the same old password. Create a new fresh one." })];
                                    case 2:
                                        _a = user;
