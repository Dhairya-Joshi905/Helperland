        ...
        this.checkLogin = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.loginService
                        ...
                        var registered, isSame, token;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!user) return [3 /*break*/, 3];
                                    registered = this.loginService.isRegister(user);
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/, res.status(401).json({ message: "Login credentials incorrect." })];
                                case 2: return [2 /*return*/, res.json({ message: "Activate your account." })];
                                case 3: return [2 /*return*/, res.status(401).json({ message: "Invalid Username or Password" })];
                            }
                        });
                    }); })
                        .catch(function (err) {
