                                    ...
                                    switch (_b.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [2 /*return*/, this.helpersService
                                                    ...
                                                    var data = _this.helpersService.createEmailData(helper.Email, token);
                            ...
                            return _this.helpersService
                                ...
                                if (helper) {
                                    ...
                                    return _this.helpersService
                                        ...
                                        .then(function (helper) {
                                        return res.status(200).json({ message: "You are now successfully registered as service provider.", helper: helper });
                                    })
                                        .catch(function (err) {
                                        console.log(err);
                                        return res.status(500).json(err);
