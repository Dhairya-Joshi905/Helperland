...
var MySettingsService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        displayDetail = {};
                        return [4 /*yield*/, this.mySettingsRepository.getUDById(userId)];
                    case 1:
                        detail = _a.sent();
                        return [4 /*yield*/, this.mySettingsRepository.getUAById(userId)];
                    case 2:
                        address = _a.sent();
                        if (detail) {
                            displayDetail = {
    ...
    MySettingsService.prototype.updateUDbyId = function (userId, user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (user.Gender === "Male")
                    user.GenderId = 1;
                    ...
                    user.GenderId = 3;
                return [2 /*return*/, this.mySettingsRepository.updateUDById(parseInt(userId), user)];
            });
        });
    };
    MySettingsService.prototype.getSPAddressById = function (SPId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.mySettingsRepository.getSPAById(SPId)];
            });
        });
    };
    MySettingsService.prototype.updateAddress = function (AId, user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.mySettingsRepository.updateUA(AId, user)];
            });
        });
    };
    MySettingsService.prototype.createAddress = function (AId, user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.mySettingsRepository.createAddress(AId, user)];
            });
        });
    };
