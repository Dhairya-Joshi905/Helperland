...
var MySettingsController = /** @class */ (function () {
    function MySettingsController(mySettingsService) {
        ...
        this.updateUDById = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
        ...
        this.CreateUpdateAddress = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var UserId;
            var _this = this;
            return __generator(this, function (_a) {
                UserId = parseInt(req.body.userId);
                if (UserId && req.body.userTypeId === 3) {
                    return [2 /*return*/, this.mySettingsService
                            ...
                            if (userAddress)
                                return _this.mySettingsService
                    ...
                    return [2 /*return*/, res.status(400).json({ message: 'input problem in request' })];
                return [2 /*return*/];
            });
        }); };
