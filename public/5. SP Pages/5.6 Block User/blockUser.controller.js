...
var BlockCustomerController = /** @class */ (function () {
    function BlockCustomerController(blockCustomerService) {
        ...
        this.PastCustomersOfSP = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var customers;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(req.body.userTypeId === 3 && req.body.userId)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.blockCustomerService.getPastCustomersOfSP(req.body.userId)];
                    case 1:
                        customers = _a.sent();
                        if (customers) {
        ...
        this.BlockCustomer = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var inCustomerList;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.blockCustomerService.hasSPWorkedForCustomer(req.body.userId, req.params.UserId)];
                    case 1:
                        inCustomerList = _a.sent();
                        if (inCustomerList)
                            return [2 /*return*/, this.blockCustomerService
                                    ...
                                    if (blockedCustomer && blockedCustomer.IsBlocked)
                                        ...
                                        return _this.blockCustomerService
                            ...
                            return [2 /*return*/, res.status(400).json({ message: 'SP has not worked for this customer' })];
                        return [3 /*break*/, 3];
                    case 2:
                        next();
                        _a.label = 3;
        ...
        this.UnblockCustomer = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
