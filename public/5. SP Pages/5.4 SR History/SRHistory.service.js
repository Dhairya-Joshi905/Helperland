...
var SRHistoryService = /** @class */ (function () {
    function SRHistoryService(serviceHistoryRepository) {
        this.serviceHistoryRepository = serviceHistoryRepository;
        this.serviceHistoryRepository = serviceHistoryRepository;
    }
    SRHistoryService.prototype.getSPSRHistory = function (userId) {
    ...
    SRHistoryService.prototype.getServiceRequestDetailById = function (srId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    SRHistoryService.prototype.getUserDetailById = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    SRHistoryService.prototype.getRatingsOfHelper = function (helperId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    // local services
    SRHistoryService.prototype.compareWithCurrentDate = function (requestHistory) {
        var srHistory = [];
    ...
    SRHistoryService.prototype.getDatForExport = function (serviceRequest) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SRHistoryService.prototype.gethistoryForDisplay = function (serviceRequest) {
        return __awaiter(this, void 0, void 0, function () {
                        ...
                        if (user)
                            if (address)
                                historyData.push({
                                    ...
                                    StartDate: serviceRequest[sr].ServiceStartDate.toString().split("-").reverse().join("-"),
    ...
    SRHistoryService.prototype.getRatingsForDisplay = function (ratings) {
        return __awaiter(this, void 0, void 0, function () {
                                ...
                                switch (_d.label) {
                                    ...
                                    case 1:
                                        ...
                                        endTimeInt = (parseFloat(startTimeArray[0]) +
                                            ...
                                            (serviceRequest === null || serviceRequest === void 0 ? void 0 : serviceRequest.ExtraHours))
                                            .toString()
                                            .split(".");
                                        if (endTimeInt[1])
                                            endTimeInt[1] = (parseInt(endTimeInt[1]) * 6).toString();
