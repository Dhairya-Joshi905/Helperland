...
var SRController = /** @class */ (function () {
    function SRController(serviceRequestService) {
        var _this = this;
        this.serviceRequestService = serviceRequestService;
        this.getAllNewSR = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
                                    ...
                                    if (SP.ZipCode === null)
                                        ...
                                        return _this.serviceRequestService
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        if (!(SRArray && SRArray.length > 0)) return [3 /*break*/, 5];
                                                        return [4 /*yield*/, this.serviceRequestService.petFilter(req.body.PetsAtHome, SRArray)];
                                                    case 1:
                                                        sRequests = _a.sent();
                                                        if (!(sRequests && sRequests.length > 0)) return [3 /*break*/, 3];
                                                        return [4 /*yield*/, this.serviceRequestService.getSRDetail(sRequests)];
                                                    case 2:
                ...
                if (req.body.userTypeId === 3)
                    return [2 /*return*/, this.serviceRequestService
                            ...
                            if (SRDetail)
                                ...
                                return res.status(404).json({ message: "request detail not available" });
                        })
                            .catch(function (error) { return res.status(500).json({ error: error }); })];
                else
                    return [2 /*return*/, res.status(401).json({ message: "Unauthorised User" })];
        ...
        this.isSRAccepted = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                if (req.params.SRId)
                    return [2 /*return*/, this.serviceRequestService
                            ...
                            if (serviceRequest) {
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                                ...
                                                return [4 /*yield*/, this.serviceRequestService.checkSPAvailability(serviceRequest.ServiceStartDate, serviceRequests, req.body.totalHour, serviceRequest.ServiceStartTime)];
                                            case 1:
                                                _a = _b.sent(), srId = _a.srId, matched = _a.matched;
                                                if (matched)
                                                    return [2 /*return*/, res.status(422).json({ message: "Another service request " + srId + " has already been assigned which has time overlap with this service request. You can’t pick this one!" })];
                                                else
                                                    next();
                                                return [3 /*break*/, 3];
                                            case 2:
                                ...
                                return res.status(422).json({ message: "This service request is no more available. It has been assigned to another provider" });
                        })
                            .catch(function (error) { return res.status(500).json({ error: error }); })];
                else
        ...
        this.acceptNewSR = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.serviceRequestService
                                ...
                                if (helpers)
                                    for (var hp in helpers) {
                                        if (helpers[hp].Email === req.body.email)
                                            continue;
                                        var data = _this.serviceRequestService.createEmailData(helpers[hp].Email, req.params.SRId);
                                        // console.log(data);
