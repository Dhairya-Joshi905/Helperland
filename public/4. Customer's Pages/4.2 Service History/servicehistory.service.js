...
var ServiceHistoryService = /** @class */ (function () {
    ...
    ;
    ServiceHistoryService.prototype.getSRHistory = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.serviceHistoryRepository.getSRHistory(userId)];
            });
        });
    };
    ;
    ServiceHistoryService.prototype.getSRDetail = function (srId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.serviceHistoryRepository.getSRDetail(srId)];
            });
        });
    };
    ;
    ServiceHistoryService.prototype.giveRating = function (ratings) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.serviceHistoryRepository.giveRating(ratings)];
            });
        });
    };
    ;
    ServiceHistoryService.prototype.getRatingBySRId = function (srId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.serviceHistoryRepository.getRatingBySRId(srId)];
            });
        });
    };
    ;
    // local services
    ServiceHistoryService.prototype.compareWithCurrentDate = function (requestHistory) {
        var srHistory = [];
