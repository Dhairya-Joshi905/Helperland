...
var DashboardService = /** @class */ (function () {
    ...
    ;
    DashboardService.prototype.getDashboard = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.dashboardRepository.getDashboard(userId)];
            });
        });
    };
    ;
    DashboardService.prototype.getSRDetail = function (srId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.dashboardRepository.getSRDetail(srId)];
            });
        });
    };
    ;
    DashboardService.prototype.getSPDashboard = function (spId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.dashboardRepository.getSPDashboard(spId)];
            });
        });
    };
    ;
    DashboardService.prototype.rescheduleSR = function (date, time, serviceId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.dashboardRepository.rescheduleSR(date, time, serviceId)];
            });
        });
    };
    ;
    DashboardService.prototype.getSPById = function (helperId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.dashboardRepository.getSPById(helperId)];
            });
        });
    };
    ;
    DashboardService.prototype.updateSRStatus = function (serviceId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.dashboardRepository.updateSRStatus(serviceId)];
            });
        });
    };
    ;
    DashboardService.prototype.compareWithCurrentDate = function (date) {
    ...
    ;
    DashboardService.prototype.isSPBusy = function (date, serviceRequest, totalHour, time) {
        var srDate, startTime, endTime;
    ...
    ;
    DashboardService.prototype.createEmailData = function (date, time, userEmail, srId) {
        var data = {
            from: 'team_helperland@gmail.com',
            to: userEmail,
            subject: 'About rescheduled service request assigned to you',
            html: "<h1>\u201CService Request ".concat(srId, " has been rescheduled by customer. New date and time are ").concat(date, " ").concat(time, "\u201D.</h1>")
        };
        return data;
    };
    ;
    DashboardService.prototype.cancelSRData = function (userEmail, srId) {
        var data = {
            from: 'team_helperland@gmail.com',
            to: userEmail,
            subject: 'About cancelled service request assigned to you',
            html: "<h1>\u201CService Request ".concat(srId, " has been cancelled by customer.</h1>")
        };
        return data;
    };
    ;
